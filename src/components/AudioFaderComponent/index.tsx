...
const AudioFaderComponent: FC<AudioFaderComponentProps> = ({faderValue, isMuted, faderChannel, faderPerson}) => {
    ...
    return (
        <div className="channel">
            <div className="bus-control">
                <div className={`button button--bus mute-button ${isMuted ? "active" : ""}`}>M</div>
            ...
            <div className="slider">
                <div className="fader-track">
                    <div className="fader" style={{transform: `translateY(${transform}px)`}}></div>
                </div>
                <div className="vca">
